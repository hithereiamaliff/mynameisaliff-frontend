...
export const DonatePage: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      '@type': 'WebPage',
      'name': 'Support YourName\'s Work | Donate',
      'description': 'Support YourName\'s work through various payment methods including DuitNow Transfer, DuitNow QR, and Touch \'n Go eWallet.',
      'url': 'https://your-website-name.co.uk/donate',
      'mainEntity': {
        '@type': 'DonateAction',
        'name': 'Donate to Support YourName\'s Work',
        'description': 'Your contribution helps me to continue creating better digital experiences for people like you and me.',
        'potentialAction': {
          '@type': 'DonateAction',
          'target': {
            '@type': 'EntryPoint',
            'urlTemplate': 'https://your-website-name.co.uk/donate'
          }
        }
      }
    });
  ...
  return (
    <>
      <SEO
        title="Support YourName's Work | Donate"
        description="Support YourName's work through various payment methods including DuitNow Transfer, DuitNow QR, and Touch 'n Go eWallet. Your contribution helps me to continue creating better digital experiences for people like you and me."
