...
import { X, ArrowRight, ArrowLeft, Train, Bus, MapPin, Download } from 'lucide-react';
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex justify-between items-center mt-6 border-t border-gray-800 pt-4">
            <button
              ...
              className="px-3 sm:px-4 py-2 text-gray-400 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 text-sm sm:text-base"
            >
